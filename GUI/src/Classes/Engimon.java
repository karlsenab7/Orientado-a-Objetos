...
public class Engimon {
    ...
    public Engimon(Engimon other) {
        engimon_name = other.get_engimon_name();
        engimon_species = other.get_engimon_species();
        level = other.get_level();
        exp = other.get_exp();
        cum_exp = other.get_cum_exp();

        int i;
        Element el;
        engimon_elements = new ArrayList<Element>();
        for (i = 0; i < other.get_engimon_elements().size(); i++) {
            engimon_elements.add(other.get_engimon_elements().get(i));
        }

        engimon_parents = new ArrayList<Engimon>();
        for (i = 0; i < other.get_engimon_parents().size(); i++) {
            engimon_parents.add(other.get_engimon_parents().get(i));
        }

        engimon_skills = new ArrayList<Skill>();
        for (i = 0; i < other.get_engimon_skills().size(); i++) {
            engimon_skills.add(other.get_engimon_skills().get(i));
        }
    ...
    // Note: tidak ada operator overloading
